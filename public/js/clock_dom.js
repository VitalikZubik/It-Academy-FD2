...
class Clock {
    constructor(parentClock) {
        ...
        this.createNumbersClock = (countHours) => {            
            for (let i = 0; i < countHours; i++) {
                let angle = (i > 0? 30 * i: 0) / 180 * Math.PI;
